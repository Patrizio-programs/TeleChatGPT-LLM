...
proxy = "http://186.121.235.66:8080"
...
gpt = Chatbot(config={"access_token": token,
              "proxy": "https://186.121.235.66:8080"})


llm = ChatGPT(chatbot=gpt, token=token)  # for start new chat
